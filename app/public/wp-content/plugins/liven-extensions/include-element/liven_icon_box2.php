<?php
	add_action( 'vc_before_init', 'liven_vc_icon_box2_integrateWithVC' );
	function liven_vc_icon_box2_integrateWithVC() {
		add_shortcode( 'liven_vc_icon_box2', 'liven_vc_icon_box2_func' );
		
		function liven_vc_icon_box2_func( $atts, $content = null ) {
   			extract( shortcode_atts( array(	
				'icon' => 'android',
				'icon_color' => '#009cff',
				'icon_box_title' => '',
				'icon_box_title_size' => '',
				'icon_box_title_align' => '',
				'icon_box_title_color' => '#fff',
			...
			$GLOBALS['pg_content'].= '					  
							  .ib'.$uniqueID.' h4 { color: '.$icon_box_title_color.'; text-align: '.$icon_box_title_align.'; font-size:'.$icon_box_title_size.'}
							  .ib'.$uniqueID.' .fa { color:'.$icon_color.'}
							  .soc-icons'.$uniqueID.' a{ margin: 10px '.$mspacing.'px 0 }
							  .ib'.$uniqueID.' .ib2-cnt{ color:'.$box_cnt_color.'; }																	
						  ';
			
			$pg_content .= '<div class="'.$liven_soc_icons_el_class.' '.$css_class.' footer-sec text-center ib'.$uniqueID.' wow '.$anim.'">
							  <i class="'.$icon.' fa-3x"></i>
							  <h4>'.$icon_box_title.'</h4><div class="ib2-cnt">'.wpb_js_remove_wpautop(do_shortcode($content), true);
								if($soc_icon != ''){
		...
		class WPBakeryShortCode_liven_vc_icon_box2 extends WPBakeryShortCode {
		}
		
		vc_map(array(
			'name' => esc_html__( 'Liven Icon Box 2', 'liven' ),
			'base' => 'liven_vc_icon_box2',
			...
			'params' => array(
				...
				array(
    	    	    'type' => 'textfield',
	        	    'heading' => esc_html__('Icon Box Title', 'liven') ,
				...
				array(
					...
					'param_name' => 'icon_box_title_size',
				...
				array(
					...
					'param_name' => 'icon_box_title_align',
					'value' => array(
				...
				array(
					...
					'param_name' => 'icon_box_title_color',
					'std' => '#fff',
					'edit_field_class' => 'vc_col-sm-6 vc_column',
				),
				array(
				...
				array(
					'type' => 'css_editor',
					'heading' => esc_html__( 'Css of Icon Box', 'liven' ),
					'param_name' => 'css',
