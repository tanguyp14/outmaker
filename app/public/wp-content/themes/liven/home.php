    ...
    <div class="container">
        ...
        <?php
            if($liven_blog_style == 'liven_blog_style_1'  ){
                if($liven_blog_sidebar == 'off' || $liven_blog_sidebar == ''){
                ?>
                    <div class="col-md-12">
                        <div class="blog liven-blog1">
                ...
                ?>
                    <div class="col-md-12">
                        <div class="blog blogfull liven-blog5">
